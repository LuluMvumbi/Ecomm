# Generated by Django 5.2.1 on 2025-11-14 09:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Cancel', 'Cancel'), ('On The Way', 'On The Way'), ('Delivered', 'Delivered'), ('Packed', 'Packed'), ('Accepted', 'Accepted'), ('Pending', 'Pending')], default='Pending', max_length=50)),
